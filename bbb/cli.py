...
def main() -> int:
    ...
    parser.add_argument('--keep-source-chapters', action=argparse.BooleanOptionalAction, default=True, help='Keep source chapters that have no target translation')
    parser.add_argument('--keep-target-chapters', action=argparse.BooleanOptionalAction, default=True, help='Keep target chapters that have no source original')
